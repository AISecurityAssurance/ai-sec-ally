...
If you’re excited about taking on this challenge and helping re-imagine how advanced analysis tools are used, please submit your resume and cover letter using the form below or email it to [careers@aisecurityassurance.com](mailto:careers@aisecurityassurance.com), highlighting previous projects (links to code is highly recommended.) 
